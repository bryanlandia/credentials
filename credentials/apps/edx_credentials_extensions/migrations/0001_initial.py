...
def add_siteconfiguration_data(apps, schema_editor):
    ...
    defaults = {
        ...
        'homepage_url': 'http://www.edx.org',
        'company_name': 'edX, Inc.',
        'verified_certificate_url': 'http://www.edx.org/verified-certificate',
        'certificate_help_url': 'http://edx.readthedocs.org/projects/edx-guide-for-students/en/latest/SFD_certificates.html#web-certificates',
    }
